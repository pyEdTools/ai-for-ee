...
**Submission to EAAI-26: The 16th Symposium on Educational Advances in Artificial Intelligence**
...
- **`assessment_rubric.md`**: A detailed rubric for grading the student submissions. (Draft below).
- **`hardware_recommendations.md`**: A list of recommended hardware kits and components, with links to purchase.

### Draft Assessment Rubric (`assessment_rubric.md`)
